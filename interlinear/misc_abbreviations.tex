...
\newglossaryentry{David}{name=David, description={David is the priest of Shatodo village}}
...
\newglossaryentry{A⪤B}{name=A$\glj$B, description={A and B are allofams; A and B belong to the same word family}}
