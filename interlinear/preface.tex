...
\textbf{2012} (check date)

Aaron Tun = Maung Maung (get details from "Creating technical
neologisms")

Also in 2017 in Chiang Mai (Lahu titles)

Had met him at Payap in 2011?

\textbf{2015}

David Lawitts (also before - check dates) - trip to Lahu villages in
three countries (2016?)

Jonathan Morris (dates?)

\textbf{2015-2016} (check dates)
...
Tyler Lau: taught me how to use FLEX

Charles Zhang (freshman) - fall of 2017; \LaTeX ized everything

\textbf{Administratrix}

Paula Floro

\textbf{Major domo}

J.B. Lowe - interviewed URAP candidates

\textbf{Granting agency}

NSF: Joan Maling - great patience with all my pleas for extensions!

Award \#BCS1252226, originally running from 9/1/13 to 2/29/16

Got no-cost extension until Aug. 31, 2017. Then continued with own funds
until January 31, 2018: STEDT/LTBZ proceeds
