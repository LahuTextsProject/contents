...
the interlinear, but only 109 in the free version. This is because it has
...
person pronoun \textbf{yɔ̂ }may be translated as \emph{he, him, she,
  ...
  \textbf{tā}: \TC{他} `he/she', \TC{她} `she', \TC{它} `it' (inanimate), \TC{祂} `He
  (deity)', \TC{牠} `he/she (animal)'.} Similarly, the remote 3rd person
