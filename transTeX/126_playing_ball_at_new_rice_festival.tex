...
14. T: \direct{pretending to misunderstand} Eight plus nine people\footnote{I.e., seventeen on one side.}
...
\direct{He imitates the sound of smacking the ball. Laughter.}
...
\direct{Some time has presumably elapsed}
...
\direct{He imitates the sound of hitting the ball. Laughter.}
...
50. H: Nineteen for my side. And we're going on twenty!\footnote{The headman jocularly lapses into Shan with the words \textbf{pə̂} \textbf{šáw} `and twenty.'}
...
73. T: \direct{presumably having gone over to the sunny side} It does
...
90. H: I bet you'll get mad! Suppose you don't win, [after putting up] such an amount!\footnote{\textbf{à-mù} is an adverb expressing a possible future unpleasantness, like English `lest'.}
...
101. : \direct{laughing} Does that include the two white men?\footnote{The author's prowess at volleyball was less than legendary in the village.}
...
\direct{Having run this into the ground, the speakers return to the ball game.}
...
178. H: \direct{simultaneously with 177} You and I make ``a pair.''
...
179. H: Let's say ten people on the other side have had their turn\footnote{'Had their turn' translates the pre-head versatile verb \textbf{qɔ̀ʔ} `one after the other.'} striking,
