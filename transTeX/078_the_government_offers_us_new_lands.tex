...
103 H: See here, now, I've grown old working old fields\footnote{hɛ-(g̈ɔ̂)-ša: a field that has already yielded a crop, an `old field'.} these many years! Among
...
106 Lisu: Stay sitting all forlorn\footnote{phɨ́ ɛ̀ mɨ ve: lit. \texttt{"}sit grayly\texttt{"}. This refers to a} and keep scratching for a living!
...
109 Cà-bo: You just sit under an eggplant-berry bush\footnote{mÁ-hɛ-pɨ̄: Thai \textit{məkhy̌a phuaŋ}. A small shrub of the eggplant} and scratch for a living!

110 H: There's a saying about the Lahu people,\footnote{Lâhu yâ qôʔ ve qôʔ qo: ``if/when we say about the ones called Lahu people''.} that \texttt{"}when one of us
...
were telling you \texttt{"}Don't do this, don't do that, it's impossible!\texttt{"}
